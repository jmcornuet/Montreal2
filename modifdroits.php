...
<body onload="resizemenu0()" onresize="resizemenu()">
	...
	<?php
		include("menu.php");
	?>
	<div class="titre1" style="text-align:center">Modification des droits d'un utilisateur du programme de gestion</span></div>
    ...
    <div class="champ">
        <fieldset class="champemprunteurs">
            <form name="nouvelAd" method="post" action="modifacces.php">
                Choisissez la personne dont vous voulez modifier les droits d'accès au programme : <br><br>
