...
<body onload="resizemenu0()" onresize="resizemenu()">
	...
	<?php
		include("menu.php");
	?>
	<div class="titre1" style="text-align:center">Modification de l'identifiant et/ou du mot de passe d'un utilisateur du programme de gestion</span></div>
    ...
    <div class="champ">
        <fieldset class="champemprunteurs">
            <form name="nouvelAd" method="post" action="modifidmdp.php">
                Choisissez la personne dont vous voulez modifier l'identifiant et/ou le mot de passe : <br><br>
